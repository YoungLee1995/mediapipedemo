...
public class CameraXPreviewHelperTest extends CameraHelper {
    ...
    public CameraXPreviewHelperTest() {
    }
    ...
    public void startCamera(Activity activity, @Nonnull ImageCapture.Builder imageCaptureBuilder, CameraFacing cameraFacing, @Nullable Size targetSize) {
    ...
    public void startCamera(Activity activity, @Nonnull ImageCapture.Builder imageCaptureBuilder, CameraFacing cameraFacing, @Nullable SurfaceTexture surfaceTexture, @Nullable Size targetSize) {
        this.imageCaptureBuilder = imageCaptureBuilder;
        this.startCamera((Context)activity, (LifecycleOwner)((LifecycleOwner)activity), cameraFacing, surfaceTexture, targetSize);
    }
    ...
    private void startCamera(Context context, LifecycleOwner lifecycleOwner, CameraFacing cameraFacing, @Nullable SurfaceTexture surfaceTexture, @Nullable Size targetSize) {
    ...
    public void takePicture(File outputFile, ImageCapture.OnImageSavedCallback onImageSavedCallback) {
        if (this.isImageCaptureEnabled) {
            ImageCapture.OutputFileOptions outputFileOptions = (new androidx.camera.core.ImageCapture.OutputFileOptions.Builder(outputFile)).build();
