...
public class Vector3D {
    ...
    public Vector3D(Position start, Position end) {
        this(end.getLocation_x() - start.getLocation_x(),
                end.getLocation_y() - start.getLocation_y(),
                end.getLocation_z() - start.getLocation_z());
    }
